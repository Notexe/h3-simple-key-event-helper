...
public final class SystemEx {
	...
	// Return a vector of classes belonging to an Application Domain.
	// In case of ad == null it will return a list of classes in the System Domain.
	static public function getApplicationDomainClasses(ad:ApplicationDomain = null):Vector.<String> {
